...
Analysis package for deaths in U.S. immigration custody. ICE deaths are fully enumerated (173 FOIA-era + 76 individual DDRs = 249; filename kept as `all_250_deaths_detailed.csv`). CBP deaths are counts-only (no ADP) from OPR “CBP-Related Deaths” reports, treated separately and not pooled with ICE.
